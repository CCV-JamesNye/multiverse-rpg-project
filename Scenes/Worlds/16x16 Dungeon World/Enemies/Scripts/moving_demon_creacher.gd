...
class_name MovingDemonCreacher

@onready var moving_demon_creacher: MovingDemonCreacher = $"."
...
@export var moving_demon_creacher_instance = moving_demon_creacher
...
func _on_animation_player_2_animation_finished(anim_name: StringName) -> void:
	if is_dying == true:
		moving_demon_creacher.queue_free()
